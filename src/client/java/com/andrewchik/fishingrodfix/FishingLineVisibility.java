...
public final class FishingLineVisibility {
    ...
    /** Whether a rod is among the local player's drawn items (ItemInHandRenderer ticks them every tick, any camera). */
    private static boolean rodDrawn(Minecraft mc) {
        ...
        return isRod(hands.fishingrodfix$getMainHandItem()) || isRod(hands.fishingrodfix$getOffHandItem());
    }
}
