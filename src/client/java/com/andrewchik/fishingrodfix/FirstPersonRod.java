...
final class FirstPersonRod {
     ...
     * idle branch, which on 1.21.1 translates by the swing inline, then calls applyEquipOffset and
     ...
     * double because 1.21.1's {@code GameRenderer.getFov} still returns one (1.21.5 made it a float).
     */
