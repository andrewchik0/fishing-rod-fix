 ...
 * {@code ItemInHandRenderer.renderArmWithItem} uses for an idle or swinging rod: the arm position
...
final class FirstPersonRod {
    ...
    // ItemInHandRenderer.applyItemArmTransform: ITEM_POS_X/Y/Z (right arm) and
    ...
    // ItemInHandRenderer.swingArm / applyItemArmAttackTransform:
