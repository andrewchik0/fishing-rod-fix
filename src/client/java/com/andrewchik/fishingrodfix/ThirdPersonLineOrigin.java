 ...
 * paragraph). On 1.21.5 nothing is deferred and one {@code VertexConsumerProvider.Immediate} (the
...
public final class ThirdPersonLineOrigin {
     ...
     * player whose hook was extracted this frame or the previous one had its rod in goes on (1.21.5's call has no stack: whether the item drawn
