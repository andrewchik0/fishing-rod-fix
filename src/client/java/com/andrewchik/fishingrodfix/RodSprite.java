...
final class RodSprite {
    ...
    // RenderPipelines' item pipelines (ITEM_CUTOUT, ITEM_TRANSLUCENT) set ALPHA_CUTOUT = 0.1
    // (ALPHA_CUTOUT_THRESHOLD_DEFAULT): core/item discards texture alpha below it, so fainter
    // pixels are not part of the visible rod.
