 ...
 * tip is measured from the block-atlas sprite (1.21.8 keeps item textures there:
...
final class RodSprite {
    ...
    private static @Nullable PixelMask visiblePixels(SpriteContents sprite) {
        ...
        // animation vanilla draws tile 0 and getDistinctFrameCount() is a dummy [1]. 1.21.8's
