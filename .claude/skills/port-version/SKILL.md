...
draw it directly in `render`; 1.21.6–1.21.8 unchecked). The method has a first-person
...
- Compare every API the fix touches across the candidate versions: the
  ...
  **one** build and widen `depends.minecraft` to a range (this repo already did
  ...
  `>=26.1 <=26.1.2` covering 26.1–26.1.2, `>=1.21.9 <=1.21.10` covering 1.21.9–1.21.10,
